...
/**
 * Servlet implementation class Admin_transaction_view
 */
@WebServlet("/Admin_transaction_view")
public class Admin_transaction_view extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public Admin_transaction_view() {
        super();
